...
* Vá até a página **DO SEU** _Pull Request_, adicione a label de _"code-review"_ e marque seus colegas:
  ...
  * No menu à direita, clique no _link_ **"Reviewers"** e digite `students`, selecione o time `tryber/students-sd-010`.
...
### 3. A barra superior deve conter um formulário de autenticação no canto direito com um input de login, um de senha e um botão de entrar
  ...
  * O formulário deve aceitar como padrão o login 'tryber@test.com' e a senha '123456'
